...
integer, parameter, public :: &
                           ...
                           COSMIC_ELECTRON_DENSITY =     5, &
                       RADIOSONDE_U_WIND_COMPONENT =     6, &
                       RADIOSONDE_V_WIND_COMPONENT =     7, &
                       RADIOSONDE_GEOPOTENTIAL_HGT =     8, &
                       RADIOSONDE_SURFACE_PRESSURE =     9, &
                            RADIOSONDE_TEMPERATURE =    10, &
                      RADIOSONDE_SPECIFIC_HUMIDITY =    11, &
                        DROPSONDE_U_WIND_COMPONENT =    12, &
                        DROPSONDE_V_WIND_COMPONENT =    13, &
                        DROPSONDE_SURFACE_PRESSURE =    14, &
                             DROPSONDE_TEMPERATURE =    15, &
                       DROPSONDE_SPECIFIC_HUMIDITY =    16, &
                         AIRCRAFT_U_WIND_COMPONENT =    17, &
                         AIRCRAFT_V_WIND_COMPONENT =    18, &
                              AIRCRAFT_TEMPERATURE =    19, &
                        AIRCRAFT_SPECIFIC_HUMIDITY =    20, &
                            ACARS_U_WIND_COMPONENT =    21, &
                            ACARS_V_WIND_COMPONENT =    22, &
                                 ACARS_TEMPERATURE =    23, &
                           ACARS_SPECIFIC_HUMIDITY =    24, &
                       MARINE_SFC_U_WIND_COMPONENT =    25, &
                       MARINE_SFC_V_WIND_COMPONENT =    26, &
                            MARINE_SFC_TEMPERATURE =    27, &
                      MARINE_SFC_SPECIFIC_HUMIDITY =    28, &
                               MARINE_SFC_PRESSURE =    29, &
                         LAND_SFC_U_WIND_COMPONENT =    30, &
                         LAND_SFC_V_WIND_COMPONENT =    31, &
                              LAND_SFC_TEMPERATURE =    32, &
                        LAND_SFC_SPECIFIC_HUMIDITY =    33, &
                                 LAND_SFC_PRESSURE =    34, &
                              SAT_U_WIND_COMPONENT =    35, &
                              SAT_V_WIND_COMPONENT =    36, &
                                  ATOV_TEMPERATURE =    37, &
                                  AIRS_TEMPERATURE =    38, &
                            AIRS_SPECIFIC_HUMIDITY =    39, &
                            GPS_PRECIPITABLE_WATER =    40, &
                      RADIOSONDE_SURFACE_ALTIMETER =    41, &
                       DROPSONDE_SURFACE_ALTIMETER =    42, &
                              MARINE_SFC_ALTIMETER =    43, &
                                LAND_SFC_ALTIMETER =    44, &
                                   METAR_ALTIMETER =    45
                                                                              
                                                                              
integer, parameter, public :: max_defined_types_of_obs =    45
