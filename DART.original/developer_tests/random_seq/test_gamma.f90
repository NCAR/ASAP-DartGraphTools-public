...
!
! $Id: test_gamma.f90 11864 2017-08-02 19:40:28Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/developer_tests/random_seq/test_gamma.f90 $"
