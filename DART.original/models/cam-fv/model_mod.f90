...
! $Id: model_mod.f90 11799 2017-07-07 21:08:09Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/models/cam-fv/model_mod.f90 $"
...
do k = 1, num_close
   ...
   !bpd6 
   !write(*,*) "Obs_which: ", k, obs_which, t_ind
