...
!
! $Id: default_model_mod.f90 11626 2017-05-11 17:27:50Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/models/utilities/default_model_mod.f90 $"
