...
!
! $Id: grid_refl_obs.f90 11626 2017-05-11 17:27:50Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/models/wrf/WRF_DART_utilities/grid_refl_obs.f90 $"
