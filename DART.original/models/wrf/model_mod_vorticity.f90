...
!
! $Id: model_mod_vorticity.f90 11694 2017-06-02 21:39:25Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/models/wrf/model_mod_vorticity.f90 $"
