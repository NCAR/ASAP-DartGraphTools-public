...
!
! $Id: filter_mod.f90 11864 2017-08-02 19:40:28Z nancy@ucar.edu $
...
!call t_stopf('MAIN:Init')
!call task_sync()
!call t_startf('MAIN:Read State')
...
!call t_stopf('MAIN:Read State')
!call task_sync()
!call t_startf('filter.main._init.postreadstate_')
...
call t_stopf('MAIN:Init')
call task_sync()
call t_startf('MAIN:AdvanceTime')
...
call t_stopf('MAIN:AdvanceTime')
call task_sync()
call t_startf('MAIN:End')
