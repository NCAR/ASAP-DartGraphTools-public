...
!
! $Id: DEFAULT_obs_kind_mod.F90 11864 2017-08-02 19:40:28Z nancy@ucar.edu $
                       ...
                       DROPSONDE_SURFACE_ALTIMETER =    37, &
                              MARINE_SFC_ALTIMETER =    38, &
                                LAND_SFC_ALTIMETER =    39, &
                                   METAR_ALTIMETER =    40, &
                           DOPPLER_RADIAL_VELOCITY =    41, &
                                RADAR_REFLECTIVITY =    42, &
                       RADAR_CLEARAIR_REFLECTIVITY =    43, &
                          PRECIPITATION_FALL_SPEED =    44, &
                             METAR_U_10_METER_WIND =    45, &
                             METAR_V_10_METER_WIND =    46, &
                         METAR_TEMPERATURE_2_METER =    47, &
                   METAR_SPECIFIC_HUMIDITY_2_METER =    48, &
                            METAR_SURFACE_PRESSURE =    49, &
                            METAR_POT_TEMP_2_METER =    50, &
                                          DEWPOINT =    51, &
                                  DEWPOINT_2_METER =    52, &
                                     BUOY_DEWPOINT =    53, &
                                     SHIP_DEWPOINT =    54, &
                                    ...
                                    BOGUS_DEWPOINT =    59, &
                                     AIRS_DEWPOINT =    60, &
                            METAR_DEWPOINT_2_METER =    61, &
                               RADIOSONDE_DEWPOINT =    62, &
                                DROPSONDE_DEWPOINT =    63, &
                                 AIRCRAFT_DEWPOINT =    64, &
                                    ACARS_DEWPOINT =    65, &
                               MARINE_SFC_DEWPOINT =    66, &
                                 LAND_SFC_DEWPOINT =    67, &
                                       TEMPERATURE =    68, &
                                 SPECIFIC_HUMIDITY =    69, &
                                          PRESSURE =    70, &
                                GPSRO_REFRACTIVITY =    71, &
                           COSMIC_ELECTRON_DENSITY =    72, &
                             BUOY_U_WIND_COMPONENT =    73, &
                             BUOY_V_WIND_COMPONENT =    74, &
                             BUOY_SURFACE_PRESSURE =    75, &
                                  BUOY_TEMPERATURE =    76, &
                             SHIP_U_WIND_COMPONENT =    77, &
                             SHIP_V_WIND_COMPONENT =    78, &
                             SHIP_SURFACE_PRESSURE =    79, &
                                  SHIP_TEMPERATURE =    80, &
                            SYNOP_U_WIND_COMPONENT =    81, &
                            SYNOP_V_WIND_COMPONENT =    82, &
                            SYNOP_SURFACE_PRESSURE =    83, &
                           SYNOP_SPECIFIC_HUMIDITY =    84, &
                                 SYNOP_TEMPERATURE =    85, &
                            AIREP_U_WIND_COMPONENT =    86, &
                            AIREP_V_WIND_COMPONENT =    87, &
                                    AIREP_PRESSURE =    88, &
                                 AIREP_TEMPERATURE =    89, &
                            AMDAR_U_WIND_COMPONENT =    90, &
                            AMDAR_V_WIND_COMPONENT =    91, &
                                    AMDAR_PRESSURE =    92, &
                                 AMDAR_TEMPERATURE =    93, &
                            PILOT_U_WIND_COMPONENT =    94, &
                            PILOT_V_WIND_COMPONENT =    95, &
                                    PILOT_PRESSURE =    96, &
                                 PILOT_TEMPERATURE =    97, &
                            BOGUS_U_WIND_COMPONENT =    98, &
                            BOGUS_V_WIND_COMPONENT =    99, &
                                    BOGUS_PRESSURE =   100, &
                                 BOGUS_TEMPERATURE =   101, &
                         PROFILER_U_WIND_COMPONENT =   102, &
                         PROFILER_V_WIND_COMPONENT =   103, &
                                 PROFILER_PRESSURE =   104, &
                                   SATEM_THICKNESS =   105, &
                           QKSWND_U_WIND_COMPONENT =   106, &
                           QKSWND_V_WIND_COMPONENT =   107, &
                                        VORTEX_LAT =   108, &
                                        VORTEX_LON =   109, &
                                       VORTEX_PMIN =   110, &
                                       VORTEX_WMAX =   111
...
integer, parameter, public :: max_defined_types_of_obs =   111
