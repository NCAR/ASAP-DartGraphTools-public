...
!
! $Id: ensemble_manager_mod.f90 11765 2017-06-27 16:19:58Z thoar@ucar.edu $
...
public :: init_ensemble_manager,      end_ensemble_manager,     get_ensemble_time,          &
          ...
          deallocate_single_copy, broadcast_copy_state
...
character(len=32 ), parameter :: revision = "$Revision: 11765 $"
character(len=128), parameter :: revdate  = "$Date: 2017-06-27 10:19:58 -0600 (Tue, 27 Jun 2017) $"
...
subroutine broadcast_copy_state(ens_handle, copy, arraydata)
...
if(ens_handle%my_pe == owner) then
   arraydata = ens_handle%vars(:, owners_index) 
   call broadcast_send_state(map_pe_to_task(ens_handle, owner), arraydata)
else 
   call broadcast_recv_state(map_pe_to_task(ens_handle, owner), arraydata)
endif

end subroutine broadcast_copy_state
!-----------------------------------------------------------------
...
if (ens_handle%transpose_type == 3) then
   ...
   call broadcast_copy_state(ens_handle, 1, ens_handle%vars(:, 1))
endif
...
! $Id: ensemble_manager_mod.f90 11765 2017-06-27 16:19:58Z thoar@ucar.edu $
! $Revision: 11765 $
! $Date: 2017-06-27 10:19:58 -0600 (Tue, 27 Jun 2017) $
