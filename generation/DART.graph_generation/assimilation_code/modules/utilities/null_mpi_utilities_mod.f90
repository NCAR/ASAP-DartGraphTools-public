...
public :: initialize_mpi_utilities, finalize_mpi_utilities,                  &
          ...
          broadcast_send_state, broadcast_recv_state, &
          broadcast_send_seqobs, broadcast_recv_seqobs, &
          io_receive_from, io_send_to, &
...
subroutine io_receive_from(src_id, destarray, time, label)
 ...
 character(len=*), intent(in), optional :: label
  ...
  call receive_from(src_id, destarray, time, label)
...
subroutine broadcast_send_state(from, array1, array2, array3, array4, array5, &
 ...
 call broadcast_send(from, array1, array2, array3, array4, array5, &
                     scalar1, scalar2, scalar3, scalar4, scalar5)

end subroutine broadcast_send_state ! bpd6
...
end subroutine broadcast_send_seqobs ! bpd6
!-----------------------------------------------------------------------------
...
subroutine broadcast_recv_state(from, array1, array2, array3, array4, array5, &
 ...
 real(r8), intent(inout), optional :: scalar1, scalar2, scalar3, scalar4, scalar5
  ...
  call broadcast_recv(from, array1, array2, array3, array4, array5, &
                      scalar1, scalar2, scalar3, scalar4, scalar5)
