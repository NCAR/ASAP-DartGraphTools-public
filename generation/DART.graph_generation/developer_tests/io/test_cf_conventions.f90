...
!
! $Id: test_cf_conventions.f90 11799 2017-07-07 21:08:09Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/developer_tests/io/test_cf_conventions.f90 $"
