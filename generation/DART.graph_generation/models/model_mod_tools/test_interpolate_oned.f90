...
!
! $Id: test_interpolate_oned.f90 11765 2017-06-27 16:19:58Z thoar@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/models/model_mod_tools/test_interpolate_oned.f90 $"
